...
export function SignInForm({ callbackUrl }: SignInFormProps) {
  ...
  async function handlePasswordSubmit(e: { preventDefault(): void }) {
    ...
    // Provider id is "password" per §7.1 (not "credentials").
  ...
  async function handleGoogleSignIn() {
    ...
    // Browser redirect fires — loading state intentionally persists.
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Sign in to your MrQ Live account</CardDescription>
      </CardHeader>
